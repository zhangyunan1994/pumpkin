...
import org.example.pumpkin.common.base.Strings;
 ...
 * org.example.pumpkin.common.base.Function, Executor) Futures.transform} and {@link
 * Futures#catching(ListenableFuture, Class, org.example.pumpkin.common.base.Function,
...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess
   ...
   * org.example.pumpkin.common.util.concurrent.SettableFuture} do not expose it to their users as an
  ...
  public String toString() {
    ...
    if (getClass().getName().startsWith("org.example.pumpkin.common.util.concurrent.")) {
