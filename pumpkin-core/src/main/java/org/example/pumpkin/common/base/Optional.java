...
public abstract class Optional<T> implements Serializable {
  ...
  /**
   * Returns the equivalent {@code org.example.pumpkin.common.base.Optional} value to the given {@code
   ...
   * org.example.pumpkin.common.base.Optional}, or {@code null} if the argument is null.
   *
