 ...
 *       sole argument, and mark it with the {@link org.example.pumpkin.common.eventbus.Subscribe}
 *       annotation.
 * </ul>
 *
 ...
 *       org.example.pumpkin.common.eventbus.EventBus#register(Object)} method on an EventBus. You'll need to
 ...
 *       org.example.pumpkin.common.eventbus.DeadEvent}. The EventBus will notify you of any events that were
 ...
 *       org.example.pumpkin.common.eventbus.EventBus#post(Object)} method.
 * </ul>
 *
 * <h2>Glossary</h2>
 *
 ...
 *       methods are marked by the {@link org.example.pumpkin.common.eventbus.Subscribe} annotation.
 *   <dt>Posting an event
