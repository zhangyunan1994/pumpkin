...
import static org.example.pumpkin.common.base.Functions.constant;
import static org.example.pumpkin.common.base.MoreObjects.toStringHelper;
...
import static org.example.pumpkin.common.collect.Lists.asList;
import static org.example.pumpkin.common.util.concurrent.ClosingFuture.State.CLOSED;
import static org.example.pumpkin.common.util.concurrent.ClosingFuture.State.CLOSING;
import static org.example.pumpkin.common.util.concurrent.ClosingFuture.State.OPEN;
import static org.example.pumpkin.common.util.concurrent.ClosingFuture.State.SUBSUMED;
import static org.example.pumpkin.common.util.concurrent.ClosingFuture.State.WILL_CLOSE;
import static org.example.pumpkin.common.util.concurrent.ClosingFuture.State.WILL_CREATE_VALUE_AND_CLOSER;
import static org.example.pumpkin.common.util.concurrent.Futures.getDone;
import static org.example.pumpkin.common.util.concurrent.Futures.immediateFuture;
import static org.example.pumpkin.common.util.concurrent.Futures.nonCancellationPropagating;
import static org.example.pumpkin.common.util.concurrent.MoreExecutors.directExecutor;
import static java.util.logging.Level.FINER;
import static java.util.logging.Level.SEVERE;
import static java.util.logging.Level.WARNING;

import org.example.pumpkin.common.annotations.Beta;
import org.example.pumpkin.common.annotations.VisibleForTesting;
import org.example.pumpkin.common.base.Function;
import org.example.pumpkin.common.collect.FluentIterable;
import org.example.pumpkin.common.collect.ImmutableList;
import org.example.pumpkin.common.util.concurrent.ClosingFuture.Combiner.AsyncCombiningCallable;
import org.example.pumpkin.common.util.concurrent.ClosingFuture.Combiner.CombiningCallable;
import org.example.pumpkin.common.util.concurrent.Futures.FutureCombiner;
...
//  @org.example.pumpkin.errorprone.annotations.DoNotMock(
//      "Use ClosingFuture.whenAllSucceed() or .whenAllComplete() instead.")
  ...
  protected void finalize() {
    if (state.get().equals(State.OPEN)) {
