...
package org.example.pumpkin.common.util.concurrent;

import static org.example.pumpkin.common.base.Preconditions.checkArgument;
...
import static org.example.pumpkin.common.base.Predicates.equalTo;
import static org.example.pumpkin.common.base.Predicates.in;
import static org.example.pumpkin.common.base.Predicates.instanceOf;
import static org.example.pumpkin.common.base.Predicates.not;
import static org.example.pumpkin.common.util.concurrent.Internal.toNanosSaturated;
import static org.example.pumpkin.common.util.concurrent.MoreExecutors.directExecutor;
import static org.example.pumpkin.common.util.concurrent.Service.State.FAILED;
import static org.example.pumpkin.common.util.concurrent.Service.State.NEW;
import static org.example.pumpkin.common.util.concurrent.Service.State.RUNNING;
import static org.example.pumpkin.common.util.concurrent.Service.State.STARTING;
import static org.example.pumpkin.common.util.concurrent.Service.State.STOPPING;
import static org.example.pumpkin.common.util.concurrent.Service.State.TERMINATED;
import static java.util.concurrent.TimeUnit.MILLISECONDS;

import org.example.pumpkin.common.annotations.GwtIncompatible;
import org.example.pumpkin.common.base.Function;
import org.example.pumpkin.common.base.MoreObjects;
import org.example.pumpkin.common.base.Stopwatch;
import org.example.pumpkin.common.collect.Collections2;
import org.example.pumpkin.common.collect.ImmutableCollection;
import org.example.pumpkin.common.collect.ImmutableList;
import org.example.pumpkin.common.collect.ImmutableMap;
import org.example.pumpkin.common.collect.ImmutableSet;
import org.example.pumpkin.common.collect.ImmutableSetMultimap;
import org.example.pumpkin.common.collect.Lists;
import org.example.pumpkin.common.collect.Maps;
import org.example.pumpkin.common.collect.MultimapBuilder;
import org.example.pumpkin.common.collect.Multimaps;
import org.example.pumpkin.common.collect.Multiset;
import org.example.pumpkin.common.collect.Ordering;
import org.example.pumpkin.common.collect.SetMultimap;
import org.example.pumpkin.common.util.concurrent.Service.State;
