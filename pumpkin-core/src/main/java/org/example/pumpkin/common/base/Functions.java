...
/**
 * Static utility methods pertaining to {@code org.example.pumpkin.common.base.Function} instances; see that
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link org.example.pumpkin.common.collect.BiMap BiMap} (or can be one), you
   * can use {@link org.example.pumpkin.common.collect.Maps#asConverter Maps.asConverter} instead to get a
