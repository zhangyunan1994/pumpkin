...
import org.example.pumpkin.common.base.Supplier;
import org.example.pumpkin.common.base.Throwables;
import org.example.pumpkin.common.collect.Lists;
import org.example.pumpkin.common.collect.Queues;
import org.example.pumpkin.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory)
          Class.forName("org.example.pumpkin.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngineWithApiClasses() {
    if (System.getProperty("org.example.pumpkin.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      Class.forName("org.example.pumpkin.appengine.api.utils.SystemProperty");
    } catch (ClassNotFoundException e) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("org.example.pumpkin.apphosting.api.ApiProxy")
