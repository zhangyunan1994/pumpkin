...
package org.example.pumpkin.common.cache;

import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static org.example.pumpkin.common.base.Preconditions.checkNotNull;
import static org.example.pumpkin.common.base.Preconditions.checkState;
import static org.example.pumpkin.common.cache.CacheBuilder.NULL_TICKER;
import static org.example.pumpkin.common.cache.CacheBuilder.UNSET_INT;
import static org.example.pumpkin.common.util.concurrent.Futures.transform;
import static org.example.pumpkin.common.util.concurrent.MoreExecutors.directExecutor;
import static org.example.pumpkin.common.util.concurrent.Uninterruptibles.getUninterruptibly;
...
import org.example.pumpkin.common.annotations.VisibleForTesting;
import org.example.pumpkin.common.base.Equivalence;
import org.example.pumpkin.common.base.Stopwatch;
import org.example.pumpkin.common.base.Ticker;
import org.example.pumpkin.common.cache.AbstractCache.SimpleStatsCounter;
import org.example.pumpkin.common.cache.AbstractCache.StatsCounter;
import org.example.pumpkin.common.cache.CacheBuilder.NullListener;
import org.example.pumpkin.common.cache.CacheBuilder.OneWeigher;
import org.example.pumpkin.common.cache.CacheLoader.InvalidCacheLoadException;
import org.example.pumpkin.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import org.example.pumpkin.common.collect.AbstractSequentialIterator;
import org.example.pumpkin.common.collect.ImmutableMap;
import org.example.pumpkin.common.collect.ImmutableSet;
import org.example.pumpkin.common.collect.Iterators;
import org.example.pumpkin.common.collect.Maps;
import org.example.pumpkin.common.collect.Sets;
import org.example.pumpkin.common.primitives.Ints;
import org.example.pumpkin.common.util.concurrent.ExecutionError;
import org.example.pumpkin.common.util.concurrent.Futures;
import org.example.pumpkin.common.util.concurrent.ListenableFuture;
import org.example.pumpkin.common.util.concurrent.SettableFuture;
import org.example.pumpkin.common.util.concurrent.UncheckedExecutionException;
import org.example.pumpkin.common.util.concurrent.Uninterruptibles;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code org.example.pumpkin.common.collect.MapMaker})
  ...
  static class LoadingValueReference<K, V> implements ValueReference<K, V> {
    ...
    public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
      try {
        ...
        return transform(
            newValue,
            new org.example.pumpkin.common.base.Function<V, V>() {
              @Override
