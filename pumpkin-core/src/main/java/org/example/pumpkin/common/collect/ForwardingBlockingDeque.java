 ...
 * @author Emily Soldal
 * @since 14.0
 * @deprecated This class has moved to {@code org.example.pumpkin.common.util.concurrent}. Please use {@link
 *     org.example.pumpkin.common.util.concurrent.ForwardingBlockingDeque} instead.
 */
@Deprecated
@GwtIncompatible
